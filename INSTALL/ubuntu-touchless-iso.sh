...
sqluser="root"
sudo mysql -e "source backend/sql/user.sql" || true
echo "============="
...
node /home/Shinobi/backend/tools/modifyConfiguration.js addToConfig="{\"cron\":{\"key\":\"$(head -c 64 < /dev/urandom | sha256sum | awk '{print substr($1,1,60)}')\"}}"
