module.exports = function(s){
    ...
    const backendLanguages = path.join(s.mainDirectory, 'languages')
    s.location = {
        ...
        languages : fs.existsSync(sharedLanguages) ? sharedLanguages : backendLanguages
    }
    try{
    ...
    if(config.liveJpegApiEnabled === undefined){config.liveJpegApiEnabled = true}
    //Child Nodes
