        ...
        if(config.ftpServer === true){
            try{
                ...
                const ftpServer = new FtpSrv({
                    ...
                    greeting: "Xenocipher FTP dropInEvent Server says hello!",
                ...
                console.error('Could not start FTP Server, please run "npm install ftp-srv" inside the Xenocipher folder.')
