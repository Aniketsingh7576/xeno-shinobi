    ...
    if(config.discordBot === true){
        try{
            ...
            const messageFooter = {
                ...
                text: config.notifyFooterText || "Xenocipher Systems"
            };
            ...
            console.log(err)
            console.log('Could not start Discord bot, please run "npm install discord.js" inside the Xenocipher folder.')
        }
    }
}
