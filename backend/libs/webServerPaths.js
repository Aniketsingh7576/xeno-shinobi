...
module.exports = function(s,config,lang,app,io){
    ...
    s.renderPage = function(req,res,paths,passables,callback){
        ...
        passables.frontendDirectory = s.frontendDirectory
    ...
    if(config.webPaths.home !== '/'){
        app.use('/libs',express.static(s.frontendDirectory + '/libs'))
    }
    [
        [config.webPaths.home,'libs','/libs'],
        [config.webPaths.super,'libs','/libs'],
        [config.webPaths.home,'assets','/assets'],
        [config.webPaths.super,'assets','/assets'],
    ].forEach((piece) => {
    ...
    if(config.renderPaths.handler!==undefined){require(s.frontendDirectory+'/'+config.renderPaths.handler+'.js').addHandlers(s,app,io,config)}
