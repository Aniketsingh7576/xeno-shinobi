$(document).ready(function () {
  ...
  var submitConfiguration = function () {
    ...
    if (errors.length === 0) {
      ...
      var html = '<p>This is a change being applied to the configuration file (conf.json). Are you sure you want to do this? You must restart Xenocipher for these changes to take effect. <b>The JSON below is what you are about to save.</b></p>'
