$(document).ready(function(){
    ...
    systemsControlsTab.find('[restart]').click(function(e){
        ...
        target.forEach(function(v){
            switch(v){
                case'system':
                    html += '<p>Do you want to restart the core (camera.js)? plugins will not be restarted. They will reconnect when Xenocipher is back online.</p>'
                break;
                case'cron':
